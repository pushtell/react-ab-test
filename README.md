...
<dd>
  <dd>#### `props.name`</dd>
  <dd>The name of the experiment. Required. Type `string`. Example: `"My Test"`</dd>
  <dd>#### `props.defaultValue`</dd>
  <dd>The default variant name of the experiment. Required. Type `string`. Example: `"A"`</dd>
</dl>
