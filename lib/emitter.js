...
var PushtellEventEmitter = (function (_EventEmitter) {
  ...
  _createClass(PushtellEventEmitter, [{
    ...
    key: 'incrementActiveExperiments',
    value: function incrementActiveExperiments(experimentName) {
    ...
    key: 'decrementActiveExperiments',
    value: function decrementActiveExperiments(experimentName) {
    ...
    value: function setExperimentValue(experimentName, variantName, emit) {
