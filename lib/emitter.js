...
var PushtellEventEmitter = (function (_EventEmitter) {
  ...
  function PushtellEventEmitter() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(PushtellEventEmitter).apply(this, arguments));
  }
  ...
  _createClass(PushtellEventEmitter, [{
    ...
    key: '_emitPlay',
    value: function _emitPlay(experimentName, variantName) {
      if (typeof experimentName !== 'string') {
        throw new Error("Required argument 'experimentName' should have type 'string'");
      }
      ...
      if (!playedExperiments[experimentName]) {
        this.emit('play', experimentName, variantName);
        playedExperiments[experimentName] = true;
      }
    }
  }, {
    key: '_resetPlayedExperiments',
    value: function _resetPlayedExperiments() {
      playedExperiments = {};
    }
  }, {
    key: '_reset',
    ...
    key: 'defineVariants',
    value: function defineVariants(experimentName, variantNames, variantWeights) {
    ...
    key: 'getSortedVariantWeights',
    value: function getSortedVariantWeights(experimentName) {
