...
try {
  ...
  render = _react2['default'].render;
  unmountComponentAtNode = _react2['default'].unmountComponentAtNode;
}

if (process.env.NODE_ENV === "production" || !_fbjsLibExecutionEnvironment.canUseDOM) {
  module.exports = {
  ...
  (function () {
    ...
    module.exports = {
      enable: function enable() {
        ...
        ReactDOM.render(_react2['default'].createElement(Debugger, null), container);
      },
      disable: function disable() {
        removeStyleSheet();
        var body = document.getElementsByTagName('body')[0];
