...
var _fbjsLibCrc32 = require("fbjs/lib/crc32");

var _fbjsLibCrc322 = _interopRequireDefault(_fbjsLibCrc32);
...
exports["default"] = _react2["default"].createClass({
  ...
  getLocalStorageValue: function getLocalStorageValue() {
    ...
    var index = typeof this.props.userIdentifier === 'string' ? Math.abs((0, _fbjsLibCrc322["default"])(this.props.userIdentifier) % variants.length) : Math.floor(Math.random() * variants.length);
