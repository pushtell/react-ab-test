	    ...
	    var Debugger = _react2["default"].createClass({
	      ...
	      render: function render() {
	        ...
	        if (this.state.visible) {
	          return _react2["default"].createElement("div", { style: debugger_style }, _react2["default"].createElement("div", { style: close_button_style, onClick: this.toggleVisibility }, "×"), _react2["default"].createElement("ul", { style: list_style }, experimentNames.map(function (experimentName) {
	            var variantNames = Object.keys(_this.state.experiments[experimentName]);
	            if (variantNames.length === 0) {
	              return;
	            }
	            return _react2["default"].createElement("li", { key: experimentName }, _react2["default"].createElement("div", { style: experiment_name_style }, experimentName), _react2["default"].createElement("ul", { style: list_style }, variantNames.map(function (variantName) {
	              return _react2["default"].createElement("li", { style: list_item_style, key: variantName }, _react2["default"].createElement("label", { style: variant_name_style, onClick: _this.setExperimentValue.bind(_this, experimentName, variantName) }, _react2["default"].createElement("input", { style: input_style, type: "radio", name: experimentName, defaultChecked: _this.state.experiments[experimentName][variantName] }), _this.state.experiments[experimentName][variantName] ? _react2["default"].createElement("b", null, variantName) : { variantName: variantName }));
	            })));
	          })), _react2["default"].createElement("div", { style: note_style }, "This panel is hidden on production builds."));
	        } else if (experimentNames.length > 0) {
	          return _react2["default"].createElement("div", { style: { cursor: "pointer" }, onClick: this.toggleVisibility }, experimentNames.length, " Experiment", experimentNames.length > 1 ? "s" : "", " ▲");
	        } else {
	          return null;
	        }
	      }
